module HDF5
  module FFI
    ...
    attach_function 'imaxdiv', [
      :intmax_t,
      :intmax_t,
    ], ImaxdivT
    
    
    attach_function 'strtoimax', [
      :string,
      :pointer,
      :int,
    ], :intmax_t
    ...
    attach_variable :H5_libinit_g, :H5_libinit_g, :bool
    
    attach_variable :H5_libterm_g, :H5_libterm_g, :bool
    
    attach_function 'H5open', [
    
    ], :herr_t
    
    
    attach_function 'H5atclose', [
      :H5_atclose_func_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5close', [
    
    ], :herr_t
    
    
    attach_function 'H5dont_atexit', [
    
    ], :herr_t
    
    
    attach_function 'H5garbage_collect', [
    
    ], :herr_t
    
    
    attach_function 'H5set_free_list_limits', [
      :int,
      :int,
      :int,
      :int,
    ...
    attach_function 'H5get_free_list_sizes', [
      :pointer,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5get_libversion', [
      :pointer,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5check_version', [
      :uint,
      :uint,
      :uint,
    ], :herr_t
    ...
    attach_function 'H5allocate_memory', [
      :size_t,
      :bool,
    ], :pointer
    
    
    attach_function 'H5resize_memory', [
      :pointer,
      :size_t,
    ], :pointer
    ...
    enum :H5I_type_t, [
      :H5I_UNINIT, 4294967294,
      :H5I_BADID, 4294967295,
      :H5I_FILE, 1,
      :H5I_GROUP, 2,
      :H5I_DATATYPE, 3,
      :H5I_DATASPACE, 4,
    ...
    attach_function 'H5Iregister', [
      :H5I_type_t,
      :pointer,
    ], :hid_t
    
    
    attach_function 'H5Iobject_verify', [
      :hid_t,
      :H5I_type_t,
    ], :pointer
    
    
    attach_function 'H5Iremove_verify', [
      :hid_t,
      :H5I_type_t,
    ], :pointer
    ...
    attach_function 'H5Iregister_type2', [
      :uint,
      :H5I_free_t,
    ], :H5I_type_t
    
    
    attach_function 'H5Iclear_type', [
      :H5I_type_t,
      :bool,
    ], :herr_t
    ...
    attach_function 'H5Iregister_type1', [
      :size_t,
      :uint,
      :H5I_free_t,
    ], :H5I_type_t
    ...
    enum :H5O_mcdt_search_ret_t, [
      :H5O_MCDT_SEARCH_ERROR, 4294967295,
    ...
    attach_function 'H5Oopen_by_idx', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Oopen_by_idx_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Oexists_by_name', [
      :hid_t,
      :string,
      :hid_t,
    ], :htri_t
    ...
    attach_function 'H5Oset_comment', [
      :hid_t,
      :string,
    ], :herr_t
    
    
    attach_function 'H5Oset_comment_by_name', [
      :hid_t,
      :string,
      :string,
      :hid_t,
    ...
    attach_function 'H5Oget_comment', [
      :hid_t,
      :string,
      :size_t,
    ], :ssize_t
    ...
    attach_function 'H5Oget_comment_by_name', [
      :hid_t,
      :string,
      :string,
      :size_t,
    ...
    attach_function 'H5Ovisit_by_name3', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Oclose_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Oflush_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Orefresh_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Oare_mdc_flushes_disabled', [
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Oopen_by_addr', [
      :hid_t,
      :haddr_t,
    ], :hid_t
    ...
    attach_function 'H5Ovisit_by_name1', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Ovisit_by_name2', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_variable :H5T_FLOAT_BFLOAT16BE_g, :H5T_FLOAT_BFLOAT16BE_g, :hid_t
    
    attach_variable :H5T_FLOAT_BFLOAT16LE_g, :H5T_FLOAT_BFLOAT16LE_g, :hid_t
    
    attach_variable :H5T_FLOAT_F8E4M3_g, :H5T_FLOAT_F8E4M3_g, :hid_t
    
    attach_variable :H5T_FLOAT_F8E5M2_g, :H5T_FLOAT_F8E5M2_g, :hid_t
    
    attach_variable :H5T_FLOAT_F6E2M3_g, :H5T_FLOAT_F6E2M3_g, :hid_t
    
    attach_variable :H5T_FLOAT_F6E3M2_g, :H5T_FLOAT_F6E3M2_g, :hid_t
    
    attach_variable :H5T_FLOAT_F4E2M1_g, :H5T_FLOAT_F4E2M1_g, :hid_t
    
    attach_variable :H5T_COMPLEX_IEEE_F16BE_g, :H5T_COMPLEX_IEEE_F16BE_g, :hid_t
    
    attach_variable :H5T_COMPLEX_IEEE_F16LE_g, :H5T_COMPLEX_IEEE_F16LE_g, :hid_t
    
    attach_variable :H5T_COMPLEX_IEEE_F32BE_g, :H5T_COMPLEX_IEEE_F32BE_g, :hid_t
    
    attach_variable :H5T_COMPLEX_IEEE_F32LE_g, :H5T_COMPLEX_IEEE_F32LE_g, :hid_t
    
    attach_variable :H5T_COMPLEX_IEEE_F64BE_g, :H5T_COMPLEX_IEEE_F64BE_g, :hid_t
    
    attach_variable :H5T_COMPLEX_IEEE_F64LE_g, :H5T_COMPLEX_IEEE_F64LE_g, :hid_t
    ...
    attach_variable :H5T_NATIVE_FLOAT_COMPLEX_g, :H5T_NATIVE_FLOAT_COMPLEX_g, :hid_t
    
    attach_variable :H5T_NATIVE_DOUBLE_COMPLEX_g, :H5T_NATIVE_DOUBLE_COMPLEX_g, :hid_t
    
    attach_variable :H5T_NATIVE_LDOUBLE_COMPLEX_g, :H5T_NATIVE_LDOUBLE_COMPLEX_g, :hid_t
    ...
    attach_function 'H5Tclose_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Tcommit_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Tcommit_anon', [
      :hid_t,
      :hid_t,
      :hid_t,
      :hid_t,
    ...
    attach_function 'H5Tenum_insert', [
      :hid_t,
      :string,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Tenum_nameof', [
      :hid_t,
      :pointer,
      :string,
      :size_t,
    ...
    attach_function 'H5Tenum_valueof', [
      :hid_t,
      :string,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Tarray_create2', [
      :hid_t,
      :uint,
      :pointer,
    ], :hid_t
    ...
    attach_function 'H5Tget_array_dims2', [
      :hid_t,
      :pointer,
    ], :int
    
    
    attach_function 'H5Tcomplex_create', [
      :hid_t,
    ], :hid_t
    
    
    attach_function 'H5Tset_tag', [
      :hid_t,
      :string,
    ], :herr_t
    ...
    attach_function 'H5Tdetect_class', [
      :hid_t,
      :H5T_class_t,
    ], :htri_t
    ...
    attach_function 'H5Tget_member_name', [
      :hid_t,
      :uint,
    ], :string
    
    
    attach_function 'H5Tget_member_index', [
      :hid_t,
      :string,
    ], :int
    
    
    attach_function 'H5Tget_member_offset', [
      :hid_t,
      :uint,
    ], :size_t
    
    
    attach_function 'H5Tget_member_class', [
      :hid_t,
      :uint,
    ], :H5T_class_t
    
    
    attach_function 'H5Tget_member_type', [
      :hid_t,
      :uint,
    ], :hid_t
    
    
    attach_function 'H5Tget_member_value', [
      :hid_t,
      :uint,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Tget_native_type', [
      :hid_t,
      :H5T_direction_t,
    ], :hid_t
    
    
    attach_function 'H5Tset_size', [
      :hid_t,
      :size_t,
    ], :herr_t
    
    
    attach_function 'H5Tset_order', [
      :hid_t,
      :H5T_order_t,
    ], :herr_t
    
    
    attach_function 'H5Tset_precision', [
      :hid_t,
      :size_t,
    ], :herr_t
    
    
    attach_function 'H5Tset_offset', [
      :hid_t,
      :size_t,
    ], :herr_t
    
    
    attach_function 'H5Tset_pad', [
      :hid_t,
      :H5T_pad_t,
      :H5T_pad_t,
    ], :herr_t
    ...
    attach_function 'H5Tset_sign', [
      :hid_t,
      :H5T_sign_t,
    ], :herr_t
    
    
    attach_function 'H5Tset_fields', [
      :hid_t,
      :size_t,
      :size_t,
      :size_t,
    ...
    attach_function 'H5Tset_ebias', [
      :hid_t,
      :size_t,
    ], :herr_t
    
    
    attach_function 'H5Tset_norm', [
      :hid_t,
      :H5T_norm_t,
    ], :herr_t
    
    
    attach_function 'H5Tset_inpad', [
      :hid_t,
      :H5T_pad_t,
    ], :herr_t
    
    
    attach_function 'H5Tset_cset', [
      :hid_t,
      :H5T_cset_t,
    ], :herr_t
    
    
    attach_function 'H5Tset_strpad', [
      :hid_t,
      :H5T_str_t,
    ], :herr_t
    
    
    attach_function 'H5Tconvert', [
      :hid_t,
      :hid_t,
      :size_t,
      :pointer,
    ...
    attach_function 'H5Tdecode1', [
      :pointer,
    ], :hid_t
    
    
    attach_function 'H5Tcommit1', [
      :hid_t,
      :string,
      :hid_t,
    ], :herr_t
    ...
    attach_function 'H5Topen1', [
      :hid_t,
      :string,
    ], :hid_t
    
    
    attach_function 'H5Tarray_create1', [
      :hid_t,
      :int,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Tget_array_dims1', [
      :hid_t,
      :pointer,
      :pointer,
    ], :int
    ...
    attach_function 'H5Aclose_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Acreate_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Acreate_by_name', [
      :hid_t,
      :string,
      :string,
      :hid_t,
    ...
    attach_function 'H5Acreate_by_name_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Adelete', [
      :hid_t,
      :string,
    ], :herr_t
    
    
    attach_function 'H5Adelete_by_idx', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Adelete_by_name', [
      :hid_t,
      :string,
      :string,
      :hid_t,
    ...
    attach_function 'H5Aexists', [
      :hid_t,
      :string,
    ], :htri_t
    
    
    attach_function 'H5Aexists_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Aexists_by_name', [
      :hid_t,
      :string,
      :string,
      :hid_t,
    ...
    attach_function 'H5Aexists_by_name_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Aget_name_by_idx', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Aiterate_by_name', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Aopen_by_idx', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Aopen_by_idx_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Aopen_by_name', [
      :hid_t,
      :string,
      :string,
      :hid_t,
    ...
    attach_function 'H5Aopen_by_name_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Arename_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Arename_by_name_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Awrite_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Arename_by_name', [
      :hid_t,
      :string,
      :string,
      :string,
    ...
    attach_function 'H5Aopen_idx', [
      :hid_t,
      :uint,
    ], :hid_t
    
    
    attach_function 'H5Aopen_name', [
      :hid_t,
      :string,
    ], :hid_t
    ...
    class H5ACCacheConfigT < ::FFI::Struct
      layout \
        :version, :int,
        :rpt_fcn_enabled, :bool,
        :open_trace_file, :bool,
        :close_trace_file, :bool,
        :trace_file_name, [:char, 1025],
        :evictions_enabled, :bool,
        :set_initial_size, :bool,
        :initial_size, :size_t,
        ...
        :decrement, :double,
        :apply_max_decrement, :bool,
        :max_decrement, :size_t,
        :epochs_before_eviction, :int,
        :apply_empty_reserve, :bool,
    ...
    enum :H5D_alloc_time_t, [
      :H5D_ALLOC_TIME_ERROR, 4294967295,
    ...
    enum :H5D_space_status_t, [
      :H5D_SPACE_STATUS_ERROR, 4294967295,
    ...
    enum :H5D_fill_time_t, [
      :H5D_FILL_TIME_ERROR, 4294967295,
    ...
    enum :H5D_fill_value_t, [
      :H5D_FILL_VALUE_ERROR, 4294967295,
    ...
    attach_function 'H5Dcreate_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Dcreate_anon', [
      :hid_t,
      :hid_t,
      :hid_t,
      :hid_t,
    ...
    attach_function 'H5Dget_space_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Dget_space_status', [
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Dget_chunk_storage_size', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Dget_num_chunks', [
      :hid_t,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Dget_chunk_info_by_coord', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Dget_chunk_info', [
      :hid_t,
      :hid_t,
      :hsize_t,
      :pointer,
    ...
    attach_function 'H5Dread_multi_async', [
      :string,
      :string,
      :uint,
      :size_t,
    ...
    attach_function 'H5Dwrite_multi', [
      :size_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Dwrite_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Dwrite_multi_async', [
      :string,
      :string,
      :uint,
      :size_t,
    ...
    attach_function 'H5Dwrite_chunk', [
      :hid_t,
      :hid_t,
      :uint32_t,
      :pointer,
    ...
    attach_function 'H5Dread_chunk2', [
      :hid_t,
      :hid_t,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Dvlen_get_buf_size', [
      :hid_t,
      :hid_t,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5Dset_extent', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Dset_extent_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Dclose_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Dget_chunk_index_type', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Dcreate1', [
      :hid_t,
      :string,
      :hid_t,
      :hid_t,
    ...
    attach_function 'H5Dopen1', [
      :hid_t,
      :string,
    ], :hid_t
    
    
    attach_function 'H5Dextend', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Dvlen_reclaim', [
      :hid_t,
      :hid_t,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5Dread_chunk1', [
      :hid_t,
      :hid_t,
      :pointer,
      :pointer,
    ...
    # [c2ffi4rb] Already defined: C_IO_FILE (struct)
    ...
    attach_function 'rename', [
      :string,
      :string,
    ], :int
    
    
    attach_function 'renameat', [
      :int,
      :string,
      :int,
      :string,
    ...
    attach_function 'open_memstream', [
      :pointer,
      :pointer,
    ], FILE.ptr
    ...
    attach_function '__asprintf', [
      :pointer,
      :string,
    ], :int
    
    
    attach_function 'asprintf', [
      :pointer,
      :string,
    ], :int
    
    
    attach_function 'vdprintf', [
      :int,
      :string,
      :__gnuc_va_list,
    ], :int
    ...
    attach_function 'vscanf', [
      :string,
      :__gnuc_va_list,
    ], :int
    
    
    attach_function 'vsscanf', [
      :string,
      :string,
      :__gnuc_va_list,
    ], :int
    ...
    attach_function 'getchar_unlocked', [
    ...
    attach_variable :H5E_RTREE_g, :H5E_RTREE_g, :hid_t
    ...
    attach_variable :H5E_THREADSAFE_g, :H5E_THREADSAFE_g, :hid_t
    ...
    attach_function 'H5Eregister_class', [
      :string,
      :string,
      :string,
    ], :hid_t
    ...
    attach_function 'H5Ecreate_stack', [
    
    ], :hid_t
    
    
    attach_function 'H5Eget_current_stack', [
    
    ], :hid_t
    
    
    attach_function 'H5Eappend_stack', [
      :hid_t,
      :hid_t,
      :bool,
    ], :herr_t
    ...
    attach_function 'H5Eis_paused', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Epause_stack', [
      :hid_t,
    ], :herr_t
    
    
    attach_function 'H5Eresume_stack', [
      :hid_t,
    ], :herr_t
    ...
    attach_function 'H5Eget_class_name', [
      :hid_t,
      :string,
      :size_t,
    ], :ssize_t
    ...
    attach_function 'H5Eauto_is_v2', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Eget_msg', [
      :hid_t,
      :pointer,
      :string,
      :size_t,
    ...
    attach_function 'H5Eclear1', [
    
    ], :herr_t
    
    
    attach_function 'H5Eget_auto1', [
      :pointer,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Epush1', [
      :string,
      :string,
      :uint,
      :H5E_major_t,
    ...
    attach_function 'H5Eset_auto1', [
      :H5E_auto1_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Ewalk1', [
      :H5E_direction_t,
      :H5E_walk1_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5EScreate', [
    
    ], :hid_t
    
    
    attach_function 'H5ESwait', [
      :hid_t,
      :uint64_t,
      :pointer,
      :pointer,
    ...
    attach_function 'H5ESget_count', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5ESget_op_counter', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5ESget_err_status', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5ESget_err_count', [
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5ESregister_insert_func', [
      :hid_t,
    ...
    attach_function 'H5ESregister_complete_func', [
      :hid_t,
    ...
    attach_function 'H5Fis_accessible', [
      :string,
      :hid_t,
    ], :htri_t
    
    
    attach_function 'H5Fcreate', [
      :string,
      :uint,
      :hid_t,
      :hid_t,
    ...
    attach_function 'H5Fcreate_async', [
      :string,
      :string,
      :uint,
      :string,
    ...
    attach_function 'H5Freopen_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Fflush', [
      :hid_t,
      :H5F_scope_t,
    ], :herr_t
    
    
    attach_function 'H5Fflush_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Fclose_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Fget_intent', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Fget_fileno', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Fget_obj_count', [
      :hid_t,
      :uint,
    ], :ssize_t
    
    
    attach_function 'H5Fget_obj_ids', [
      :hid_t,
      :uint,
      :size_t,
      :pointer,
    ...
    attach_function 'H5Fget_vfd_handle', [
      :hid_t,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Fget_filesize', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Fget_eoa', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Fincrement_filesize', [
      :hid_t,
      :hsize_t,
    ], :herr_t
    
    
    attach_function 'H5Fget_file_image', [
      :hid_t,
      :pointer,
      :size_t,
    ], :ssize_t
    ...
    attach_function 'H5Fget_mdc_hit_rate', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Fget_mdc_size', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Fset_libver_bounds', [
      :hid_t,
      :H5F_libver_t,
      :H5F_libver_t,
    ], :herr_t
    ...
    attach_function 'H5Fget_mdc_logging_status', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Fget_mdc_image_info', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Fget_dset_no_attrs_hint', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Fset_dset_no_attrs_hint', [
      :hid_t,
      :bool,
    ], :herr_t
    ...
    attach_function 'H5Fset_latest_format', [
      :hid_t,
      :bool,
    ], :herr_t
    ...
    attach_function 'H5FDdriver_query', [
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Lcreate_hard', [
      :hid_t,
      :string,
      :hid_t,
      :string,
    ...
    attach_function 'H5Lcreate_hard_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Lcreate_soft', [
      :string,
      :hid_t,
      :string,
      :hid_t,
    ...
    attach_function 'H5Lcreate_soft_async', [
      :string,
      :string,
      :uint,
      :string,
    ...
    attach_function 'H5Ldelete_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Ldelete_by_idx', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Ldelete_by_idx_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Lget_val_by_idx', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Lexists_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Lget_name_by_idx', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Literate_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Literate_by_name2', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Lvisit_by_name2', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Lunpack_elink_val', [
      :pointer,
      :size_t,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Lcreate_external', [
      :string,
      :string,
      :hid_t,
      :string,
    ...
    attach_function 'H5Literate_by_name1', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    attach_function 'H5Lvisit_by_name1', [
      :hid_t,
      :string,
      :H5_index_t,
      :H5_iter_order_t,
    ...
    enum :H5G_storage_type_t, [
      :H5G_STORAGE_TYPE_UNKNOWN, 4294967295,
    ...
    attach_function 'H5Gcreate_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Gcreate_anon', [
      :hid_t,
      :hid_t,
      :hid_t,
    ], :hid_t
    ...
    attach_function 'H5Gclose_async', [
      :string,
      :string,
      :uint,
      :hid_t,
    ...
    attach_function 'H5Gopen1', [
      :hid_t,
      :string,
    ], :hid_t
    
    
    attach_function 'H5Glink', [
      :hid_t,
      :H5L_type_t,
      :string,
      :string,
    ...
    attach_function 'H5Gunlink', [
      :hid_t,
      :string,
    ], :herr_t
    
    
    attach_function 'H5Gget_linkval', [
      :hid_t,
      :string,
      :size_t,
      :string,
    ...
    attach_function 'H5Gset_comment', [
      :hid_t,
      :string,
      :string,
    ], :herr_t
    ...
    attach_function 'H5Gget_comment', [
      :hid_t,
      :string,
      :size_t,
      :string,
    ...
    attach_function 'H5Gget_num_objs', [
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Gget_objname_by_idx', [
      :hid_t,
      :hsize_t,
      :string,
      :size_t,
    ...
    attach_function 'H5Gget_objtype_by_idx', [
      :hid_t,
      :hsize_t,
    ], :H5G_obj_t
    ...
    attach_function 'H5VLregister_connector_by_name', [
      :string,
      :hid_t,
    ], :hid_t
    
    
    attach_function 'H5VLregister_connector_by_value', [
      :H5VL_class_value_t,
      :hid_t,
    ], :hid_t
    ...
    attach_function 'H5VLget_connector_name', [
      :hid_t,
      :string,
      :size_t,
    ], :ssize_t
    ...
    attach_function 'H5VLquery_optional', [
      :hid_t,
      :H5VL_subclass_t,
      :int,
      :pointer,
    ...
    attach_function 'H5VLobject_is_native', [
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Rget_obj_type1', [
      :hid_t,
      :H5R_type_t,
      :pointer,
    ], :H5G_obj_t
    ...
    attach_function 'H5Rdereference1', [
      :hid_t,
      :H5R_type_t,
      :pointer,
    ], :hid_t
    ...
    attach_function 'H5Rget_obj_type2', [
      :hid_t,
      :H5R_type_t,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Rdereference2', [
      :hid_t,
      :hid_t,
      :H5R_type_t,
      :pointer,
    ...
    # [c2ffi4rb] Already defined: H5VLClassT (struct)
    ...
    attach_function 'H5VLget_file_type', [
      :pointer,
      :hid_t,
      :hid_t,
    ], :hid_t
    ...
    attach_function 'H5VLregister_opt_operation', [
      :H5VL_subclass_t,
      :string,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5VLfind_opt_operation', [
      :H5VL_subclass_t,
      :string,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5VLunregister_opt_operation', [
      :H5VL_subclass_t,
      :string,
    ], :herr_t
    ...
    attach_function 'H5Scombine_hyperslab', [
      :hid_t,
      :H5S_seloper_t,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Scombine_select', [
      :hid_t,
      :H5S_seloper_t,
      :hid_t,
    ], :hid_t
    ...
    attach_function 'H5Screate_simple', [
      :int,
      :pointer,
      :pointer,
    ], :hid_t
    ...
    attach_function 'H5Sextent_copy', [
      :hid_t,
      :hid_t,
    ], :herr_t
    
    
    attach_function 'H5Sextent_equal', [
      :hid_t,
      :hid_t,
    ], :htri_t
    
    
    attach_function 'H5Sget_regular_hyperslab', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Sget_select_bounds', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Sget_select_elem_pointlist', [
      :hid_t,
      :hsize_t,
      :hsize_t,
      :pointer,
    ...
    attach_function 'H5Sget_select_hyper_blocklist', [
      :hid_t,
      :hsize_t,
      :hsize_t,
      :pointer,
    ...
    attach_function 'H5Sget_simple_extent_dims', [
      :hid_t,
      :pointer,
      :pointer,
    ], :int
    ...
    attach_function 'H5Smodify_select', [
      :hid_t,
      :H5S_seloper_t,
      :hid_t,
    ], :herr_t
    ...
    attach_function 'H5Soffset_simple', [
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Ssel_iter_create', [
      :hid_t,
      :size_t,
      :uint,
    ], :hid_t
    ...
    attach_function 'H5Ssel_iter_get_seq_list', [
      :hid_t,
      :size_t,
      :size_t,
      :pointer,
    ...
    attach_function 'H5Ssel_iter_reset', [
      :hid_t,
      :hid_t,
    ], :herr_t
    
    
    attach_function 'H5Sselect_adjust', [
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Sselect_copy', [
      :hid_t,
      :hid_t,
    ], :herr_t
    
    
    attach_function 'H5Sselect_elements', [
      :hid_t,
      :H5S_seloper_t,
      :size_t,
      :pointer,
    ...
    attach_function 'H5Sselect_hyperslab', [
      :hid_t,
      :H5S_seloper_t,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Sselect_intersect_block', [
      :hid_t,
      :pointer,
      :pointer,
    ], :htri_t
    ...
    attach_function 'H5Sselect_project_intersection', [
      :hid_t,
      :hid_t,
      :hid_t,
    ], :hid_t
    ...
    attach_function 'H5Sselect_shape_same', [
      :hid_t,
      :hid_t,
    ], :htri_t
    ...
    attach_function 'H5Sset_extent_simple', [
      :hid_t,
      :int,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Zget_filter_info', [
      :H5Z_filter_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pcreate_class', [
      :hid_t,
      :string,
    ...
    attach_function 'H5Pequal', [
      :hid_t,
      :hid_t,
    ], :htri_t
    
    
    attach_function 'H5Pexist', [
      :hid_t,
      :string,
    ], :htri_t
    
    
    attach_function 'H5Pget', [
      :hid_t,
      :string,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_nprops', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_size', [
      :hid_t,
      :string,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pisa_class', [
      :hid_t,
      :hid_t,
    ], :htri_t
    
    
    attach_function 'H5Piterate', [
      :hid_t,
      :pointer,
      :H5P_iterate_t,
      :pointer,
    ...
    attach_function 'H5Premove', [
      :hid_t,
      :string,
    ], :herr_t
    
    
    attach_function 'H5Pset', [
      :hid_t,
      :string,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_attr_creation_order', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_attr_phase_change', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_filter2', [
      :hid_t,
      :uint,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_filter_by_id2', [
      :hid_t,
      :H5Z_filter_t,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_obj_track_times', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pmodify_filter', [
      :hid_t,
      :H5Z_filter_t,
      :uint,
      :size_t,
    ...
    attach_function 'H5Premove_filter', [
      :hid_t,
      :H5Z_filter_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_attr_creation_order', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_attr_phase_change', [
      :hid_t,
      :uint,
      :uint,
    ], :herr_t
    ...
    attach_function 'H5Pset_deflate', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_filter', [
      :hid_t,
      :H5Z_filter_t,
      :uint,
      :size_t,
    ...
    attach_function 'H5Pset_obj_track_times', [
      :hid_t,
      :bool,
    ], :herr_t
    
    
    attach_function 'H5Pget_file_space_page_size', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_file_space_strategy', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_istore_k', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_shared_mesg_index', [
      :hid_t,
      :uint,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_shared_mesg_nindexes', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_shared_mesg_phase_change', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_userblock', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pset_file_space_page_size', [
      :hid_t,
      :hsize_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_file_space_strategy', [
      :hid_t,
    ...
    attach_function 'H5Pset_istore_k', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_shared_mesg_index', [
      :hid_t,
      :uint,
      :uint,
      :uint,
    ...
    attach_function 'H5Pset_shared_mesg_nindexes', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_shared_mesg_phase_change', [
      :hid_t,
      :uint,
      :uint,
    ], :herr_t
    ...
    attach_function 'H5Pset_userblock', [
      :hid_t,
      :hsize_t,
    ], :herr_t
    
    
    attach_function 'H5Pget_alignment', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_core_write_tracking', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_driver_config_str', [
      :hid_t,
      :string,
      :size_t,
    ], :ssize_t
    ...
    attach_function 'H5Pget_elink_file_cache_size', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_evict_on_close', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_family_offset', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_fclose_degree', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_file_image', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_file_locking', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_gc_references', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_libver_bounds', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_mdc_log_options', [
      :hid_t,
      :pointer,
      :string,
      :pointer,
    ...
    attach_function 'H5Pget_meta_block_size', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_metadata_read_attempts', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_multi_type', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_object_flush_cb', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_page_buffer_size', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_sieve_buf_size', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_small_data_block_size', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_vol_id', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_vol_info', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pset_alignment', [
      :hid_t,
      :hsize_t,
      :hsize_t,
    ], :herr_t
    ...
    attach_function 'H5Pset_core_write_tracking', [
      :hid_t,
      :bool,
      :size_t,
    ], :herr_t
    ...
    attach_function 'H5Pset_driver_by_name', [
      :hid_t,
      :string,
      :string,
    ], :herr_t
    ...
    attach_function 'H5Pset_driver_by_value', [
      :hid_t,
      :H5FD_class_value_t,
      :string,
    ], :herr_t
    ...
    attach_function 'H5Pset_elink_file_cache_size', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_evict_on_close', [
      :hid_t,
      :bool,
    ], :herr_t
    
    
    attach_function 'H5Pset_family_offset', [
      :hid_t,
      :hsize_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_fclose_degree', [
      :hid_t,
      :H5F_close_degree_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_file_image', [
      :hid_t,
      :pointer,
      :size_t,
    ], :herr_t
    ...
    attach_function 'H5Pset_file_locking', [
      :hid_t,
      :bool,
      :bool,
    ], :herr_t
    ...
    attach_function 'H5Pset_gc_references', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_libver_bounds', [
      :hid_t,
      :H5F_libver_t,
      :H5F_libver_t,
    ], :herr_t
    ...
    attach_function 'H5Pset_mdc_log_options', [
      :hid_t,
      :bool,
      :string,
      :bool,
    ...
    attach_function 'H5Pset_meta_block_size', [
      :hid_t,
      :hsize_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_metadata_read_attempts', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_multi_type', [
      :hid_t,
      :H5FD_mem_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_object_flush_cb', [
      :hid_t,
      :H5F_flush_cb_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pset_sieve_buf_size', [
      :hid_t,
      :size_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_small_data_block_size', [
      :hid_t,
      :hsize_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_vol', [
      :hid_t,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_vol_cap_flags', [
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pset_page_buffer_size', [
      :hid_t,
      :size_t,
      :uint,
      :uint,
    ...
    attach_function 'H5Pset_relax_file_integrity_checks', [
      :hid_t,
      :uint64_t,
    ], :herr_t
    
    
    attach_function 'H5Pget_relax_file_integrity_checks', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pfill_value_defined', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_alloc_time', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_chunk', [
      :hid_t,
      :int,
      :pointer,
    ], :int
    ...
    attach_function 'H5Pget_chunk_opts', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_dset_no_attrs_hint', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_virtual_spatial_tree', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_external', [
      :hid_t,
      :uint,
      :size_t,
      :string,
    ...
    attach_function 'H5Pget_fill_time', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_fill_value', [
      :hid_t,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_virtual_count', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_virtual_dsetname', [
      :hid_t,
      :size_t,
      :string,
      :size_t,
    ...
    attach_function 'H5Pget_virtual_filename', [
      :hid_t,
      :size_t,
      :string,
      :size_t,
    ...
    attach_function 'H5Pget_virtual_srcspace', [
      :hid_t,
      :size_t,
    ], :hid_t
    
    
    attach_function 'H5Pget_virtual_vspace', [
      :hid_t,
      :size_t,
    ], :hid_t
    
    
    attach_function 'H5Pset_alloc_time', [
      :hid_t,
      :H5D_alloc_time_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_chunk', [
      :hid_t,
      :int,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pset_chunk_opts', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_dset_no_attrs_hint', [
      :hid_t,
      :bool,
    ], :herr_t
    
    
    attach_function 'H5Pset_virtual_spatial_tree', [
      :hid_t,
      :bool,
    ], :herr_t
    
    
    attach_function 'H5Pset_external', [
      :hid_t,
      :string,
      :HDoff_t,
      :hsize_t,
    ...
    attach_function 'H5Pset_fill_time', [
      :hid_t,
      :H5D_fill_time_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_fill_value', [
      :hid_t,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pset_scaleoffset', [
      :hid_t,
      :H5Z_SO_scale_type_t,
      :int,
    ], :herr_t
    ...
    attach_function 'H5Pset_virtual', [
      :hid_t,
      :hid_t,
      :string,
      :string,
    ...
    attach_function 'H5Pget_append_flush', [
      :hid_t,
      :uint,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_chunk_cache', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_efile_prefix', [
      :hid_t,
      :string,
      :size_t,
    ], :ssize_t
    ...
    attach_function 'H5Pget_virtual_prefix', [
      :hid_t,
      :string,
      :size_t,
    ], :ssize_t
    ...
    attach_function 'H5Pget_virtual_printf_gap', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_virtual_view', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pset_append_flush', [
      :hid_t,
      :uint,
      :pointer,
      :H5D_append_cb_t,
    ...
    attach_function 'H5Pset_chunk_cache', [
      :hid_t,
      :size_t,
      :size_t,
      :double,
    ...
    attach_function 'H5Pset_efile_prefix', [
      :hid_t,
      :string,
    ], :herr_t
    
    
    attach_function 'H5Pset_virtual_prefix', [
      :hid_t,
      :string,
    ], :herr_t
    
    
    attach_function 'H5Pset_virtual_printf_gap', [
      :hid_t,
      :hsize_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_virtual_view', [
      :hid_t,
      :H5D_vds_view_t,
    ], :herr_t
    
    
    attach_function 'H5Pget_btree_ratios', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_data_transform', [
      :hid_t,
      :string,
      :size_t,
    ], :ssize_t
    ...
    attach_function 'H5Pget_hyper_vector_size', [
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_type_conv_cb', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_vlen_mem_manager', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pset_btree_ratios', [
      :hid_t,
      :double,
      :double,
      :double,
    ...
    attach_function 'H5Pset_data_transform', [
      :hid_t,
      :string,
    ], :herr_t
    
    
    attach_function 'H5Pset_edc_check', [
      :hid_t,
      :H5Z_EDC_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_filter_callback', [
      :hid_t,
      :H5Z_filter_func_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pset_hyper_vector_size', [
      :hid_t,
      :size_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_preserve', [
      :hid_t,
      :bool,
    ], :herr_t
    
    
    attach_function 'H5Pset_type_conv_cb', [
      :hid_t,
    ...
    attach_function 'H5Pset_vlen_mem_manager', [
      :hid_t,
      :H5MM_allocate_t,
      :pointer,
      :H5MM_free_t,
    ...
    attach_function 'H5Pset_dataset_io_hyperslab_selection', [
      :hid_t,
      :uint,
      :H5S_seloper_t,
      :pointer,
    ...
    attach_function 'H5Pset_selection_io', [
      :hid_t,
      :H5D_selection_io_mode_t,
    ], :herr_t
    
    
    attach_function 'H5Pget_selection_io', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_no_selection_io_cause', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_actual_selection_io_mode', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pset_modify_write_buf', [
      :hid_t,
      :bool,
    ], :herr_t
    
    
    attach_function 'H5Pget_modify_write_buf', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_create_intermediate_group', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pset_create_intermediate_group', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pget_est_link_info', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_link_creation_order', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_link_phase_change', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_local_heap_size_hint', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pset_est_link_info', [
      :hid_t,
      :uint,
      :uint,
    ], :herr_t
    ...
    attach_function 'H5Pset_link_creation_order', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_link_phase_change', [
      :hid_t,
      :uint,
      :uint,
    ], :herr_t
    ...
    attach_function 'H5Pset_local_heap_size_hint', [
      :hid_t,
      :size_t,
    ], :herr_t
    
    
    attach_function 'H5Pget_char_encoding', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pset_char_encoding', [
      :hid_t,
      :H5T_cset_t,
    ], :herr_t
    
    
    attach_function 'H5Pget_elink_acc_flags', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_elink_cb', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pget_elink_prefix', [
      :hid_t,
      :string,
      :size_t,
    ], :ssize_t
    ...
    attach_function 'H5Pget_nlinks', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pset_elink_acc_flags', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_elink_cb', [
      :hid_t,
    ...
    attach_function 'H5Pset_elink_fapl', [
      :hid_t,
      :hid_t,
    ], :herr_t
    
    
    attach_function 'H5Pset_elink_prefix', [
      :hid_t,
      :string,
    ], :herr_t
    
    
    attach_function 'H5Pset_nlinks', [
      :hid_t,
      :size_t,
    ], :herr_t
    
    
    attach_function 'H5Padd_merge_committed_dtype_path', [
      :hid_t,
      :string,
    ], :herr_t
    ...
    attach_function 'H5Pget_copy_object', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5Pget_mcdt_search_cb', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5Pset_copy_object', [
      :hid_t,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5Pset_mcdt_search_cb', [
      :hid_t,
    ...
    attach_function 'H5Pget_filter1', [
      :hid_t,
      :uint,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_filter_by_id1', [
      :hid_t,
      :H5Z_filter_t,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_version', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pset_file_space', [
      :hid_t,
    ...
    attach_function 'H5Pget_file_space', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5PLreplace', [
      :string,
      :uint,
    ], :herr_t
    
    
    attach_function 'H5PLinsert', [
      :string,
      :uint,
    ], :herr_t
    ...
    attach_function 'H5ESinsert_request', [
      :hid_t,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5ESget_requests', [
      :hid_t,
      :H5_iter_order_t,
      :pointer,
      :pointer,
    ...
    # [c2ffi4rb] Already defined: H5FDT (struct)
    ...
    attach_function 'H5Iregister_future', [
      :H5I_type_t,
      :pointer,
    ...
    attach_function 'H5Tcompiler_conv', [
      :hid_t,
      :hid_t,
    ], :htri_t
    
    
    # attach_function 'H5TSmutex_acquire', [
    #   :uint,
    #   :pointer,
    # ], :herr_t
    ...
    attach_function 'H5VLcmp_connector_cls', [
      :pointer,
      :hid_t,
      :hid_t,
    ], :herr_t
    ...
    attach_function 'H5VLwrap_register', [
      :pointer,
      :H5I_type_t,
    ], :hid_t
    ...
    attach_function 'H5VLopen_lib_context', [
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5VLclose_lib_context', [
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5VLget_object', [
      :pointer,
      :hid_t,
    ], :pointer
    
    
    attach_function 'H5VLget_wrap_ctx', [
      :pointer,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5VLwrap_object', [
      :pointer,
      :H5I_type_t,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5VLunwrap_object', [
      :pointer,
      :hid_t,
    ], :pointer
    
    
    attach_function 'H5VLfree_wrap_ctx', [
      :pointer,
      :hid_t,
    ], :herr_t
    
    
    attach_function 'H5VLinitialize', [
      :hid_t,
      :hid_t,
    ], :herr_t
    ...
    attach_function 'H5VLget_cap_flags', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5VLget_value', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5VLcopy_connector_info', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5VLcmp_connector_info', [
      :pointer,
      :hid_t,
      :pointer,
      :pointer,
    ...
    attach_function 'H5VLfree_connector_info', [
      :hid_t,
      :pointer,
    ], :herr_t
    
    
    attach_function 'H5VLconnector_info_to_str', [
      :pointer,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5VLconnector_str_to_info', [
      :string,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5VLattr_write', [
      :pointer,
      :hid_t,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5VLattr_close', [
      :pointer,
      :hid_t,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5VLdataset_read', [
      :size_t,
      :pointer,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5VLdataset_write', [
      :size_t,
      :pointer,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5VLdataset_close', [
      :pointer,
      :hid_t,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5VLdatatype_close', [
      :pointer,
      :hid_t,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5VLfile_create', [
      :string,
      :uint,
      :hid_t,
      :hid_t,
    ...
    attach_function 'H5VLfile_close', [
      :pointer,
      :hid_t,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5VLgroup_close', [
      :pointer,
      :hid_t,
      :hid_t,
      :pointer,
    ...
    attach_function 'H5VLintrospect_get_conn_cls', [
      :pointer,
      :hid_t,
      :H5VL_get_conn_lvl_t,
      :pointer,
    ...
    attach_function 'H5VLintrospect_get_cap_flags', [
      :pointer,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5VLintrospect_opt_query', [
      :pointer,
      :hid_t,
      :H5VL_subclass_t,
      :int,
    ...
    attach_function 'H5VLrequest_wait', [
      :pointer,
      :hid_t,
      :uint64_t,
      :pointer,
    ...
    attach_function 'H5VLrequest_notify', [
      :pointer,
      :hid_t,
    ...
    attach_function 'H5VLrequest_cancel', [
      :pointer,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_function 'H5VLrequest_free', [
      :pointer,
      :hid_t,
    ], :herr_t
    
    
    attach_function 'H5VLblob_put', [
      :pointer,
      :hid_t,
      :pointer,
      :size_t,
    ...
    attach_variable :H5VL_NATIVE_g, :H5VL_NATIVE_g, :hid_t
    ...
    attach_variable :H5FD_CORE_id_g, :H5FD_CORE_id_g, :hid_t
    
    attach_function 'H5Pset_fapl_core', [
      :hid_t,
      :size_t,
      :bool,
    ], :herr_t
    ...
    attach_function 'H5Pget_fapl_core', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_variable :H5FD_FAMILY_id_g, :H5FD_FAMILY_id_g, :hid_t
    
    attach_function 'H5Pset_fapl_family', [
      :hid_t,
      :hsize_t,
      :hid_t,
    ], :herr_t
    ...
    attach_function 'H5Pget_fapl_family', [
      :hid_t,
      :pointer,
      :pointer,
    ], :herr_t
    ...
    attach_variable :H5FD_LOG_id_g, :H5FD_LOG_id_g, :hid_t
    
    attach_function 'H5Pset_fapl_log', [
      :hid_t,
      :string,
      :ulong_long,
      :size_t,
    ...
    attach_variable :H5FD_MULTI_id_g, :H5FD_MULTI_id_g, :hid_t
    
    attach_function 'H5Pset_fapl_multi', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pget_fapl_multi', [
      :hid_t,
      :pointer,
      :pointer,
      :pointer,
    ...
    attach_function 'H5Pset_fapl_split', [
      :hid_t,
      :string,
      :hid_t,
      :string,
    ...
    attach_variable :H5FD_ONION_id_g, :H5FD_ONION_id_g, :hid_t
    ...
    attach_function 'H5FDonion_get_revision_count', [
      :string,
      :hid_t,
      :pointer,
    ], :herr_t
    ...
    attach_variable :H5FD_SEC2_id_g, :H5FD_SEC2_id_g, :hid_t
    ...
    attach_variable :H5FD_SPLITTER_id_g, :H5FD_SPLITTER_id_g, :hid_t
    ...
    attach_variable :H5FD_STDIO_id_g, :H5FD_STDIO_id_g, :hid_t
    ...
    attach_variable :H5VL_PASSTHRU_g, :H5VL_PASSTHRU_g, :hid_t
