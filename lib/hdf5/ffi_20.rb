module HDF5
  module FFI
    ...
    attach_function 'H5Iregister_type2', %i[
      uint
      H5I_free_t
    ], :H5I_type_t
    ...
    attach_function 'H5Iregister_type1', %i[
      size_t
      uint
      H5I_free_t
    ], :H5I_type_t
    ...
    attach_function 'H5Dread_chunk2', %i[
      hid_t
      hid_t
      pointer
      pointer
    ...
    attach_function 'H5Dread_chunk1', %i[
      hid_t
      hid_t
      pointer
      pointer
    ...
    attach_function 'H5Eis_paused', %i[
      hid_t
      pointer
    ], :herr_t
    ...
    attach_function 'H5Pget_virtual_spatial_tree', %i[
      hid_t
      pointer
    ], :herr_t
    ...
    attach_function 'H5Pset_virtual_spatial_tree', %i[
      hid_t
      bool
    ], :herr_t
